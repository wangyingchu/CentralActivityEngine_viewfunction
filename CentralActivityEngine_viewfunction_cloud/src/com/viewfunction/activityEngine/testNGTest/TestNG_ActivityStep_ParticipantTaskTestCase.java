...
public class TestNG_ActivityStep_ParticipantTaskTestCase {
	...
	public void testRoleQueue_ActivityStep_ParticipantTaskOperation() throws ActivityEngineRuntimeException, ActivityEngineActivityException, ActivityEngineProcessException, ActivityEngineDataException, FileNotFoundException{
		...
		dfoperOnwer.setDisplayName("ҵ�񾭰���");
		...
		dfoperVerifyResult.setDisplayName("ҵ�񻨷�������");
		...
		Assert.assertEquals(ad_1Arr[0].getDataFieldDefinition().getDisplayName(), "ҵ�����ջ���");
		...
		Assert.assertEquals(ad_1Arr[1].getDataFieldDefinition().getDisplayName(), "ҵ�񾭰���");
		...
		for(int i=0;i<ad_2Arr.length;i++){
			if(ad_2Arr[i].getDataFieldDefinition().getFieldName().equals("operationVerfifyResult")){
				...
				Assert.assertEquals(ad_2Arr[i].getDataFieldDefinition().getDisplayName(), "ҵ�񻨷�������");
